...
await check('admin and student secrets are production grade', async () => {
  ...
  if (process.env.ADMIN_PASSWORD === 'admin123') throw new Error('ADMIN_PASSWORD cannot be admin123')
  assertNotPlaceholder('ADMIN_PASSWORD', process.env.ADMIN_PASSWORD)
