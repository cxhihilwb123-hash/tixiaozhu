...
import { ArrowLeft, BookOpen, Clock3, Download, FileText, Filter, Search, ShoppingBag, Sparkles, Target } from 'lucide-react'
...
const QuestionStorePage = ({ onBack, onStartPractice }) => {
  const {
    studentProfile,
    pointsAccount,
    contentPurchases,
